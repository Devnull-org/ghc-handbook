...
<ExampleExplorer
  example="Gadt"
  stages={['renamed', 'typechecked', 'types', 'core-desugared']}
...
with the `forall`s and contexts you did not write spelled out.
...
three-line version of exactly this program: <a
href={withBase('/traces/refine/')}>watch a GADT match become an implication</a>.
