...
<ExampleExplorer
  ...
  caption="The Typechecked tab shows the elaborated program: types resolved, and class constraints turned into explicit dictionary arguments that carry through into Core."
/>

Between **Renamed** and **Typechecked**, `describe` gains its `Show a` dictionary
— that is a solved Wanted, with its evidence filled in.
